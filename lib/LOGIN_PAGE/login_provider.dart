...
import 'package:movieapps/HOME_PAGE/home_page.dart';
...
class LoginProvider extends ChangeNotifier {
  ...
  userCheck({context}) async {
    ...
    if (loginPassWordController.text.isEmpty &&
        loginUserNameController.text.isEmpty) {
      ...
      if (loginUserNameController.text.toString() == getUserDetail[0] &&
          loginPassWordController.text.toString() == getUserDetail[2]) {
        List<String> loginDetils = [
